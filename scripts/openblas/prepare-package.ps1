...
lib.exe /nologo /machine:$Arch /def:openblas/exports/libopenblas.def /out:install/lib/libopenblas.lib
...
Remove-Item install/lib/*.a, install/lib/cmake, install/lib/pkgconfig -Recurse
